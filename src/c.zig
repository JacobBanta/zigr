...
pub const TigrFont = extern struct {
    bitmap: [*c]Tigr = null,
    numGlyphs: c_int = 0,
    glyphs: [*c]TigrGlyph = null,
    pub const tigrFreeFont = __root.tigrFreeFont;
    pub const tigrTextWidth = __root.tigrTextWidth;
    pub const tigrTextHeight = __root.tigrTextHeight;
};
